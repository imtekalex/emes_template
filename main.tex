...
% Examiners
\firstExaminer{Prof. Dr. Im Tek}
\firstExaminerDepartment{IMTEK -- Department of Microsystems Engineering}
\firstExaminerChair{Laboratory for something that likely has a long title as well}
...
\supervisorChair{Laboratory for something that likely has a long title as well}
...
% \ifchair{EMES}
%     \chair{Professur für Elektrische Messtechnik und Eingebettete Systeme}\fi
% \ifchair{SYSCOP}
%     \chair{Systems Control and Optimization Laboratory}\fi
...
% \firstExaminerChair{Professur für irgendwas mit sicherlich ziemlich langem titel}
...
% \supervisorChair{Professur für irgendwas mit sicherlich ziemlich langem titel}
