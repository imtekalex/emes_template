...
\section{Examples for Your Document}
    ...
    \begin{figure}[ht]
            \centering
            \includegraphics[width=\textwidth]{\figpath some_image.pdf}
            \caption{This is some image with left (a) and right (b) parts. \cite{Multiple_View_Geometry_in_Computer_Vision}.}
