...
\iflanguage{english}{
    ...
    \newcommand{\coverTitle}        {Submitted to the \uniEn\\
                                     \@institute\\
                                     \@chair}
    \newcommand{\integrityTitle}    {\@chair\\
                                     \@institute\\
                                     \uniEn}
...
\newcommand{\decleration} {
    \begin{titlepage}
        \newgeometry{left=2.5cm+\theBCOR,right=2.5cm,top=2.7cm,bottom=2.5cm}
        \begin{center}
            \thispagestyle{plain}
            ...
            \parbox{0.8\textwidth} {
                ...
                \par\noindent\makebox[5cm][l]{Place, Date} \hfill\makebox[5cm][l]{Signature}%
            }
        \end{center}
    \end{titlepage}
}
